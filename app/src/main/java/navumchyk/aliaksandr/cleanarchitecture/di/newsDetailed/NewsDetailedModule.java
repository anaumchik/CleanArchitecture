...
public class NewsDetailedModule {
    ...
    @Provides
    @NewsDetailedScope
    INewsDetailedFragmentRepository provideINewsDetailedRepository() {
        return new NewsDetailedFragmentRepository();
    }

    @Provides
    @NewsDetailedScope
    INewsDetailedFragmentInteractor provideINewsDetailedInteractor(INewsDetailedFragmentRepository repository) {
